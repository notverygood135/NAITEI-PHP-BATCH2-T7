                ...
                <div class="space-y-4 md:flex md:items-center md:justify-between md:gap-6 md:space-y-0">
                  ...
                  <div class="flex items-center justify-betweeen md:order-3 md:justify-end">
                    ...
                    <div class="text-end md:order-4 md:w-32">
                      <p class="text-base font-bold text-gray-900 dark:text-white">${{ $cart_item->qty * $cart_item->product()->price }}</p>
                    </div>
                  </div>

                  <div class="w-full min-w-0 flex-1 space-y-4 md:order-2 md:max-w-md">
                    <a href="{{ route('products.show', ['product' => $cart_item->product()->id]) }}" class="text-base font-medium text-gray-900 hover:underline dark:text-white">
            ...
            <div class="mt-6 grid grid-cols-3 gap-4 sm:mt-8">
              @foreach ($trend_items as $trend_item)
                <div
                  ...
                  <div>
                    <p class="text-lg font-bold leading-tight text-red-600 dark:text-red-500">${{ $trend_item->price }}</p>
                  </div>
